...
fun Context.showToast(res: Int) {
    runCatching { Toast.makeText(this, res, Toast.LENGTH_LONG).show() }
}
...
fun Context.hasWriteExternalDirectoryPermission(): Boolean {
    return isPermissionGranted(Manifest.permission.WRITE_EXTERNAL_STORAGE) || Build.VERSION.SDK_INT > Build.VERSION_CODES.Q
}

fun Context.hasReadExternalDirectoryPermission(): Boolean {
    return isPermissionGranted(Manifest.permission.READ_EXTERNAL_STORAGE) || Build.VERSION.SDK_INT > Build.VERSION_CODES.S_V2
}
